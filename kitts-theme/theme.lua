...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/kitts-theme"
...
function theme.at_screen_connect(s)
    ...
    s.mytaglist = awful.widget.taglist {
        ...
        widget_template = {
            ...
            create_callback = function(self, t, index, objects)
                local dot = self:get_children_by_id('dot_widget')[1]
                if t.selected then
                    self.fg = "#ffffff"
                    if dot then
                        dot.font = 'monospace 14'
                    end
                else
                    self.fg = "#666666"
                    if dot then
                        dot.font = 'monospace 10'
                    end
                end
            end,

            -- Called when tag state changes
    ...
    local centeredclock = wibox.widget {
        format = "%a %b %d  %H:%M",
